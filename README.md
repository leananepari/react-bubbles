...
- [x] Explain what a token is used for.<br>
  Token is like a password given after successfull authentication which you can use to communicate with the backend.
- [x] What steps can you take in your web apps to keep your data secure?<br>
  JWT would be one way to keep data protected.
- [x] Describe how web servers work.<br>
  A web server is a software program that 'serves' web pages upon request.
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.<br>
